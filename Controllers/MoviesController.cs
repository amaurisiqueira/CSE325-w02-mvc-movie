...
tratando de agregar el searc*/
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, string searchYear)
        {
            ...
            //probar para ver si filtra el anyo.
            ...
            // Antes del return View:
            ViewData["CurrentYear"] = searchYear;

            return View(movieGenreVM);
        }

        // POST: Movies/Index (opcional, si quieres POST también)
        [HttpPost]
